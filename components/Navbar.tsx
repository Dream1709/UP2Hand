      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" aria-label="Main navigation">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center gap-4 md:gap-6">
            <form onSubmit={handleSearch} className="relative w-full max-w-xl hidden md:block" role="search">
              ...
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full bg-up-purple px-3 py-1 text-xs font-medium text-white hover:bg-up-purple-light transition-colors"
              >
                ค้นหา
              </button>
            </form>
        ...
        {isSearchOpen && (
          <form onSubmit={handleSearch} id="mobile-search" className="md:hidden px-4 pb-4" role="search">
            <label htmlFor="mobile-search" className="sr-only">ค้นหาสินค้า</label>
            <div className="relative">
              <input
                ...
                className="w-full rounded-full border border-gray-300 bg-gray-50 px-4 py-2 pl-10 text-sm text-gray-900 placeholder-gray-500 focus:border-up-purple focus:bg-white focus:outline-none focus:ring-2 focus:ring-up-purple/20"
              />
              <svg className="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full bg-up-purple px-3 py-1 text-xs font-medium text-white hover:bg-up-purple-light">
                ค้นหา
              </button>
            </div>
          </form>
