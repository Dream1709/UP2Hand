...
- [x] 7.3 แสดงผลประวัติรีวิวและคะแนนสะสมในหน้า Profile ของผู้ใช้

## Phase 8: Admin & Moderation
- [x] 8.1 สร้าง Route Guard สำหรับหน้า `/admin` (ตรวจ role == 'admin')
- [x] 8.2 หน้ารายการสินค้าทั้งหมด พร้อมปุ่มให้ Admin ลบโพสต์ที่ทำผิดกฎ
